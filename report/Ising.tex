...
\begin{minipage}[b]{0.49\textwidth}
    ...
    \subcaption{Speedup factor heatmap.}
...
\begin{minipage}[b]{0.49\textwidth}
    ...
    \subcaption{Time per system size and number of sweeps, averaged over all system sizes, for different temperatures.}
...
\begin{minipage}[b]{\textwidth}
    ...
    \subcaption{Total time vs.\ $N$ for all temperatures.}
    \label{fig:speedup_ising_total}
\end{minipage}
