...
\begin{equation}
  \lfloor \rho \rfloor \geq S_k  \sum_{i \in \partial k}S_i= \Lambda_k.
  \label{eq:flip_int}
\end{equation}
...
We show in the \Cref{alg:ising_classic} the shared random number implementation of the Metropolis algorithm. This implementation is valid for all models, given a change in the threshold in~\eqref{eq:flip_escape_condition}.
\vspace{1em}
\begin{algorithm}[H]
\DontPrintSemicolon
