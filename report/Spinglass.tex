...
\end{equation}
Both the bitwise and the classic implementation are thus similar to this of the Ising model, and we will not present them further in this report. The bitwise algorithm for the spin glass model closely resembles that of the Ising one, it can be found in the appendix, see \Cref{alg:SG_bitwise}.\\
...
\begin{minipage}[b]{\textwidth}
    ...
    \label{fig:total_time_vs_N_spinglass}
\end{minipage}
