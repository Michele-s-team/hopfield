...
\myindent We present in \Cref{fig:speedup_hopfield} the performance analysis of the code. Several values of $\alpha$ and lattice sizes have been tested.
\begin{figure}[htbp]
\centering
% ── Top row ───────────────────────────────────────────────────────────────
...
\begin{minipage}[b]{0.49\textwidth}
    ...
    \subcaption{Total time grouped by values of $\alpha$, depending on the temperature.}
    \label{fig:total_time_by_alpha_hopfield}
\end{minipage}
...
\begin{minipage}[b]{\textwidth}
    ...
    \label{fig:total_time_vs_N_hopfield}
\end{minipage}
\caption{Performance analysis of the bitwise and classical Hopfield Metropolis implementations. The speedup factors have been averaged over the different values of $\alpha$.}
