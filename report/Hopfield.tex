...
\begin{equation}
    \lfloor \rho \rfloor + \sum_{\langle k,i\rangle} \tilde{G}_{ki} + 2p\sum_{\langle k,i\rangle} C_{ki} \geq  pn_k+
    2\sum_{\langle k,i\rangle} C_{ki}\, \oplus \tilde{G}_{ki}
\end{equation}
...
This is strictly equivalent to setting the column of $\tilde{G}_{ik}$ to 0 where $C_{ki}$ is zero and leave it untouched else.
