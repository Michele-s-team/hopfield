...
A parameter of particular interest in this model is its storage capacity, define as the number of patterns to be stored over the size of the network: $\alpha = p /N$ with p the number of patterns to be stored.
