...
A parameter of particular interest in this model is its storage load, define as the number of patterns to be stored over the size of the network: $\alpha = p /N$ with p the number of patterns to be stored. The equilibrium properties of the model, depending both on the temperature and on this storage load have been extensively studies in \cite{Amit1985,AMIT1987,Amit1989,Sompolinsky1988}. We show in \Cref{fig:phase_diagram} the phase diagram of the Hopfield network.
...
\caption{Phase diagram of the Hopfield model, extracted from \cite{Mezard2017}.}
