...
int main() {
    ...
    for (int i = 0; i < sizes.size(); ++i) {
        ...
        bits.evolve_save(ran,0.1, "../results/magnetizations/");  //evolve for all N_sweeps without saving intermediate data; to save, use ‘evolve_save’ and specify the save frequency
