...
public:
    ...
    void OpenCSVFiles(const string& filename);    // Opens the CSV files where the magnetizations will be saved
    void CloseCSVFiles();
    void SaveMagnetizations(int);                 // saves the magnetizations of all 64 realizations in a file with the speicified number of sweeps
};
